...
import com.gietu.avyakt2o.utils.Constants
...
class TeamForm : AppCompatActivity() {
  private lateinit var  EventType :String
    ...
    val list = listOf("Song","Dance","Mono Acting/Mimicry","Drama (Based on Short story 10 mins)","Idea Presentation Event","Web puzzle. (Web eye)")
