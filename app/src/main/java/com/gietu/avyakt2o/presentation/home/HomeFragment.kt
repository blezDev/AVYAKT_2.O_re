...
import com.gietu.avyakt2o.Adapter.ImageAdapter
import com.gietu.avyakt2o.Adapter.RegistrationReAdapter
import com.gietu.avyakt2o.R
import com.gietu.avyakt2o.data.Auth
import com.gietu.avyakt2o.data.RegisterRecycleView
import com.gietu.avyakt2o.data.ShowEvent
import com.gietu.avyakt2o.databinding.FragmentHomeBinding
import com.gietu.avyakt2o.presentation.Forms.GameHostActivity
import com.gietu.avyakt2o.presentation.Forms.SoloForm
import com.gietu.avyakt2o.presentation.Forms.TeamForm
import com.gietu.avyakt2o.presentation.Forms.TshirtActivity
import com.gietu.avyakt2o.presentation.sars.SarsHostActivity
import com.gietu.avyakt2o.utils.Constants.EVENT_NAME
import com.gietu.avyakt2o.utils.Constants.EVENT_TYPE
import com.gietu.avyakt2o.utils.Constants.MAXSIZE
import com.gietu.avyakt2o.utils.Constants.MINSIZE
...
class HomeFragment : Fragment() {
    ...
    private fun routeTo(EventType: String, EventName: String)
    {
        when(EventType)
        {
            ...
            "GDSC(Hack for Giet)" -> {
                val uri = Uri.parse("https://unstop.com/p/hack-for-gietu-google-developer-student-clubs-gdsc-458043")
            ...
            "Code Debugging. (Cyber Security)" -> formType(0,EventType,EventName,1,5)
            ...
            "Workshop" -> formType(0,EventType,EventName,1,3)
            "Idea Presentation Event" -> formType(1,EventType,EventName,1,3)
            ...
            "G.K Quiz. (Organising team)" -> formType(0,EventType,EventName,4,5)
            ...
            "Dance" -> formType(1,EventType,EventName,1,10)
            "Fashion Show" -> formType(0,EventType,EventName,1,5)
            "Mono Acting/Mimicry" -> formType(1,EventType,EventName,1,8)
            "Drama (Based on Short story 10 mins)" -> formType(1,EventType,EventName,1,10)
            "tshirts"->formType(3,EventType,EventName,1,5)
            "stalls"->formType(1,EventType,EventName,2,10)
