package com.gietu.avyakt2o.presentation.login
...
import com.gietu.avyakt2o.presentation.Forgot.Forgot
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            { logProgressBar.visibility = View.VISIBLE
                ...
                loginViewModel.retService.login(com.gietu.avyakt2o.data.Login(email,etPassword.text.toString())).enqueue(
