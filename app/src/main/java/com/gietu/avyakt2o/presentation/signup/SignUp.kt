package com.gietu.avyakt2o.presentation.signup
...
import com.gietu.avyakt2o.data.RegisterStatus
...
class SignUp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var options = arrayOf("1st Year","2nd Year","3rd Year","4th Year")
         ...
         etYear.adapter = ArrayAdapter<String>(this,R.layout.signupspinner,options)
